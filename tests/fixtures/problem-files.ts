...
export function createProblemFileFixtures(): ProblemFile[] {
  return [
    problemFixture({
      ...
      solvedAt: "2026-07-08",
      status: "B",
      knowledge: ["math.number-theory", "bitwise.bit-manipulation"],
      tags: ["因子分解", "二进制最低位"],
      reviews: [],
    }),
    problemFixture({
      ...
      solvedAt: "2026-08-02",
      status: "C",
      knowledge: ["greedy-constructive.greedy"],
      tags: ["贪心", "排序", "博弈"],
      reviews: [],
    }),
    problemFixture({
    ...
    problemFixture({
      ...
      solvedAt: "2026-07-03",
      status: "B",
      knowledge: ["string.pattern-matching"],
      tags: ["字符串模拟", "边界处理"],
      reviews: [],
    }),
  ];
